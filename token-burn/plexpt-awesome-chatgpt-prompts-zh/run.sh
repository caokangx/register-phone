#!/usr/bin/env bash
# Auto-generated runner for Awesome Chatgpt Prompts Zh
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="plexpt-awesome-chatgpt-prompts-zh"
REPO_URL="https://github.com/PlexPt/awesome-chatgpt-prompts-zh.git"
PROJECT_NAME="plexpt-awesome-chatgpt-prompts-zh"
