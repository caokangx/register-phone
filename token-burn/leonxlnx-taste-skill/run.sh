#!/usr/bin/env bash
# Auto-generated runner for Taste Skill
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="leonxlnx-taste-skill"
REPO_URL="https://github.com/Leonxlnx/taste-skill.git"
PROJECT_NAME="leonxlnx-taste-skill"
