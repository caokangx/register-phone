#!/usr/bin/env bash
# Auto-generated runner for English Level Up Tips
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="byoungd-english-level-up-tips"
REPO_URL="https://github.com/byoungd/English-level-up-tips.git"
PROJECT_NAME="byoungd-english-level-up-tips"
