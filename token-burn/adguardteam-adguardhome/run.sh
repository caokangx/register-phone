#!/usr/bin/env bash
# Auto-generated runner for Adguardhome
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="adguardteam-adguardhome"
REPO_URL="https://github.com/AdguardTeam/AdGuardHome.git"
PROJECT_NAME="adguardteam-adguardhome"
