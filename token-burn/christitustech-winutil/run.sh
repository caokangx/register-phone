#!/usr/bin/env bash
# Auto-generated runner for Winutil
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="christitustech-winutil"
REPO_URL="https://github.com/ChrisTitusTech/winutil.git"
PROJECT_NAME="christitustech-winutil"
