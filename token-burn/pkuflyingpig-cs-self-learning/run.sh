#!/usr/bin/env bash
# Auto-generated runner for Cs Self Learning
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="pkuflyingpig-cs-self-learning"
REPO_URL="https://github.com/PKUFlyingPig/cs-self-learning.git"
PROJECT_NAME="pkuflyingpig-cs-self-learning"
