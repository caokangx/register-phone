#!/usr/bin/env bash
# Auto-generated runner for Apollo 11
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="chrislgarry-apollo-11"
REPO_URL="https://github.com/chrislgarry/Apollo-11.git"
PROJECT_NAME="chrislgarry-apollo-11"
