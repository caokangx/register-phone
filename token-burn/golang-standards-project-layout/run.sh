#!/usr/bin/env bash
# Auto-generated runner for Project Layout
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="golang-standards-project-layout"
REPO_URL="https://github.com/golang-standards/project-layout.git"
PROJECT_NAME="golang-standards-project-layout"
