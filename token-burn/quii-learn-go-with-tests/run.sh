#!/usr/bin/env bash
# Auto-generated runner for Learn Go With Tests
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="quii-learn-go-with-tests"
REPO_URL="https://github.com/quii/learn-go-with-tests.git"
PROJECT_NAME="quii-learn-go-with-tests"
