#!/usr/bin/env bash
# Auto-generated runner for Front End Developer Interview Questions
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="h5bp-front-end-developer-interview-questions"
REPO_URL="https://github.com/h5bp/Front-end-Developer-Interview-Questions.git"
PROJECT_NAME="h5bp-front-end-developer-interview-questions"
