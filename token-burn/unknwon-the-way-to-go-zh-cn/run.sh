#!/usr/bin/env bash
# Auto-generated runner for The Way To Go Zh Cn
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="unknwon-the-way-to-go-zh-cn"
REPO_URL="https://github.com/unknwon/the-way-to-go_ZH_CN.git"
PROJECT_NAME="unknwon-the-way-to-go-zh-cn"
