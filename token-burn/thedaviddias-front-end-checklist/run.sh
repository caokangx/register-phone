#!/usr/bin/env bash
# Auto-generated runner for Front End Checklist
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="thedaviddias-front-end-checklist"
REPO_URL="https://github.com/thedaviddias/Front-End-Checklist.git"
PROJECT_NAME="thedaviddias-front-end-checklist"
