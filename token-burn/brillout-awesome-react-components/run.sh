#!/usr/bin/env bash
# Auto-generated runner for Awesome React Components
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="brillout-awesome-react-components"
REPO_URL="https://github.com/brillout/awesome-react-components.git"
PROJECT_NAME="brillout-awesome-react-components"
