#!/usr/bin/env bash
# Auto-generated runner for Yugabyte Db
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="yugabyte-yugabyte-db"
REPO_URL="https://github.com/yugabyte/yugabyte-db.git"
PROJECT_NAME="yugabyte-yugabyte-db"
