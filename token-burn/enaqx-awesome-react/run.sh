#!/usr/bin/env bash
# Auto-generated runner for Awesome React
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="enaqx-awesome-react"
REPO_URL="https://github.com/enaqx/awesome-react.git"
PROJECT_NAME="enaqx-awesome-react"
