#!/usr/bin/env bash
# Auto-generated runner for Type Challenges
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="type-challenges-type-challenges"
REPO_URL="https://github.com/type-challenges/type-challenges.git"
PROJECT_NAME="type-challenges-type-challenges"
