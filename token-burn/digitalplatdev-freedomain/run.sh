#!/usr/bin/env bash
# Auto-generated runner for Freedomain
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="digitalplatdev-freedomain"
REPO_URL="https://github.com/DigitalPlatDev/FreeDomain.git"
PROJECT_NAME="digitalplatdev-freedomain"
