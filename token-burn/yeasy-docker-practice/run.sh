#!/usr/bin/env bash
# Auto-generated runner for Docker Practice
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="yeasy-docker-practice"
REPO_URL="https://github.com/yeasy/docker_practice.git"
PROJECT_NAME="yeasy-docker-practice"
