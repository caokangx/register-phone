#!/usr/bin/env bash
# Auto-generated runner for Awesome Java
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="akullpp-awesome-java"
REPO_URL="https://github.com/akullpp/awesome-java.git"
PROJECT_NAME="akullpp-awesome-java"
