#!/usr/bin/env bash
# Auto-generated runner for Awesome Hacking
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="hack-with-github-awesome-hacking"
REPO_URL="https://github.com/Hack-with-Github/Awesome-Hacking.git"
PROJECT_NAME="hack-with-github-awesome-hacking"
