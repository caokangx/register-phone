#!/usr/bin/env bash
# Auto-generated runner for Learn Claude Code
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="shareai-lab-learn-claude-code"
REPO_URL="https://github.com/shareAI-lab/learn-claude-code.git"
PROJECT_NAME="shareai-lab-learn-claude-code"
