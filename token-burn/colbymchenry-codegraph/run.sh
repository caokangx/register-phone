#!/usr/bin/env bash
# Auto-generated runner for Codegraph
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="colbymchenry-codegraph"
REPO_URL="https://github.com/colbymchenry/codegraph.git"
PROJECT_NAME="colbymchenry-codegraph"
