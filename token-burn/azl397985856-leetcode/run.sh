#!/usr/bin/env bash
# Auto-generated runner for Leetcode
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="azl397985856-leetcode"
REPO_URL="https://github.com/azl397985856/leetcode.git"
PROJECT_NAME="azl397985856-leetcode"
