#!/usr/bin/env bash
# Auto-generated runner for Ai Agents For Beginners
# Usage:
#   ./run.sh              # foreground
...
REPO_URL="https://github.com/microsoft/ai-agents-for-beginners.git"
PROJECT_NAME="microsoft-ai-agents-for-beginners"
