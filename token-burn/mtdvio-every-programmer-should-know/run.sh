#!/usr/bin/env bash
# Auto-generated runner for Every Programmer Should Know
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="mtdvio-every-programmer-should-know"
REPO_URL="https://github.com/mtdvio/every-programmer-should-know.git"
PROJECT_NAME="mtdvio-every-programmer-should-know"
