#!/usr/bin/env bash
# Auto-generated runner for Segment Anything
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="facebookresearch-segment-anything"
REPO_URL="https://github.com/facebookresearch/segment-anything.git"
PROJECT_NAME="facebookresearch-segment-anything"
