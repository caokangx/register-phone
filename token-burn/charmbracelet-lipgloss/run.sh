#!/usr/bin/env bash
# Auto-generated runner for Lipgloss
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="charmbracelet-lipgloss"
REPO_URL="https://github.com/charmbracelet/lipgloss.git"
PROJECT_NAME="charmbracelet-lipgloss"
