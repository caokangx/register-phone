#!/usr/bin/env bash
# Auto-generated runner for Centrifugo
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="centrifugal-centrifugo"
REPO_URL="https://github.com/centrifugal/centrifugo.git"
PROJECT_NAME="centrifugal-centrifugo"
