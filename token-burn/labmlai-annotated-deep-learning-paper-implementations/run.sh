#!/usr/bin/env bash
# Auto-generated runner for Annotated Deep Learning Paper Implementations
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="labmlai-annotated-deep-learning-paper-implementations"
REPO_URL="https://github.com/labmlai/annotated_deep_learning_paper_implementations.git"
PROJECT_NAME="labmlai-annotated-deep-learning-paper-implementations"
