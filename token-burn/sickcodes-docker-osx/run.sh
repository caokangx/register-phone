#!/usr/bin/env bash
# Auto-generated runner for Docker Osx
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="sickcodes-docker-osx"
REPO_URL="https://github.com/sickcodes/Docker-OSX.git"
PROJECT_NAME="sickcodes-docker-osx"
