#!/usr/bin/env bash
# Auto-generated runner for Distribution
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="distribution-distribution"
REPO_URL="https://github.com/distribution/distribution.git"
PROJECT_NAME="distribution-distribution"
