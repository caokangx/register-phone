#!/usr/bin/env bash
# Auto-generated runner for Gin Vue Admin
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="flipped-aurora-gin-vue-admin"
REPO_URL="https://github.com/flipped-aurora/gin-vue-admin.git"
PROJECT_NAME="flipped-aurora-gin-vue-admin"
