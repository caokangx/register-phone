#!/usr/bin/env bash
# Auto-generated runner for System Prompts And Models Of Ai Tools
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="x1xhlol-system-prompts-and-models-of-ai-tools"
REPO_URL="https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools.git"
PROJECT_NAME="x1xhlol-system-prompts-and-models-of-ai-tools"
