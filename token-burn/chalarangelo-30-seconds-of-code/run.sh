#!/usr/bin/env bash
# Auto-generated runner for 30 Seconds Of Code
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="chalarangelo-30-seconds-of-code"
REPO_URL="https://github.com/Chalarangelo/30-seconds-of-code.git"
PROJECT_NAME="chalarangelo-30-seconds-of-code"
