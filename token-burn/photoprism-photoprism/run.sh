#!/usr/bin/env bash
# Auto-generated runner for Photoprism
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="photoprism-photoprism"
REPO_URL="https://github.com/photoprism/photoprism.git"
PROJECT_NAME="photoprism-photoprism"
