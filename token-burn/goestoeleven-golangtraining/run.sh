#!/usr/bin/env bash
# Auto-generated runner for Golangtraining
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="goestoeleven-golangtraining"
REPO_URL="https://github.com/GoesToEleven/GolangTraining.git"
PROJECT_NAME="goestoeleven-golangtraining"
