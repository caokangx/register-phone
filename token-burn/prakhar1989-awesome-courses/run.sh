#!/usr/bin/env bash
# Auto-generated runner for Awesome Courses
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="prakhar1989-awesome-courses"
REPO_URL="https://github.com/prakhar1989/awesome-courses.git"
PROJECT_NAME="prakhar1989-awesome-courses"
