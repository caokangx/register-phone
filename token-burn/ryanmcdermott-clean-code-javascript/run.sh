#!/usr/bin/env bash
# Auto-generated runner for Clean Code Javascript
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="ryanmcdermott-clean-code-javascript"
REPO_URL="https://github.com/ryanmcdermott/clean-code-javascript.git"
PROJECT_NAME="ryanmcdermott-clean-code-javascript"
