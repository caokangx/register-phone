#!/usr/bin/env bash
# Auto-generated runner for Image Spec
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="opencontainers-image-spec"
REPO_URL="https://github.com/opencontainers/image-spec.git"
PROJECT_NAME="opencontainers-image-spec"
