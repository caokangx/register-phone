#!/usr/bin/env bash
# Auto-generated runner for Awesome Design Patterns
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="dovamir-awesome-design-patterns"
REPO_URL="https://github.com/DovAmir/awesome-design-patterns.git"
PROJECT_NAME="dovamir-awesome-design-patterns"
