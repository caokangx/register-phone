#!/usr/bin/env bash
# Auto-generated runner for Realworld
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="realworld-apps-realworld"
REPO_URL="https://github.com/realworld-apps/realworld.git"
PROJECT_NAME="realworld-apps-realworld"
