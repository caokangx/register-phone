#!/usr/bin/env bash
# Auto-generated runner for Awesome Machine Learning
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="josephmisiti-awesome-machine-learning"
REPO_URL="https://github.com/josephmisiti/awesome-machine-learning.git"
PROJECT_NAME="josephmisiti-awesome-machine-learning"
