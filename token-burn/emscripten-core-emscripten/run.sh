#!/usr/bin/env bash
# Auto-generated runner for Emscripten
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="emscripten-core-emscripten"
REPO_URL="https://github.com/emscripten-core/emscripten.git"
PROJECT_NAME="emscripten-core-emscripten"
