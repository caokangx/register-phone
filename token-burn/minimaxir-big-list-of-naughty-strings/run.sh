#!/usr/bin/env bash
# Auto-generated runner for Big List Of Naughty Strings
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="minimaxir-big-list-of-naughty-strings"
REPO_URL="https://github.com/minimaxir/big-list-of-naughty-strings.git"
PROJECT_NAME="minimaxir-big-list-of-naughty-strings"
