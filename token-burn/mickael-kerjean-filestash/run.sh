#!/usr/bin/env bash
# Auto-generated runner for Filestash
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="mickael-kerjean-filestash"
REPO_URL="https://github.com/mickael-kerjean/filestash.git"
PROJECT_NAME="mickael-kerjean-filestash"
