#!/usr/bin/env bash
# Auto-generated runner for Javascript Algorithms
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="trekhleb-javascript-algorithms"
REPO_URL="https://github.com/trekhleb/javascript-algorithms.git"
PROJECT_NAME="trekhleb-javascript-algorithms"
