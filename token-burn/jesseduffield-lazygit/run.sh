#!/usr/bin/env bash
# Auto-generated runner for Lazygit
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="jesseduffield-lazygit"
REPO_URL="https://github.com/jesseduffield/lazygit.git"
PROJECT_NAME="jesseduffield-lazygit"
