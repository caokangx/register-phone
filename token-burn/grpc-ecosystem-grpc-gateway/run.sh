#!/usr/bin/env bash
# Auto-generated runner for Grpc Gateway
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="grpc-ecosystem-grpc-gateway"
REPO_URL="https://github.com/grpc-ecosystem/grpc-gateway.git"
PROJECT_NAME="grpc-ecosystem-grpc-gateway"
