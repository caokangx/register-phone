#!/usr/bin/env bash
# Auto-generated runner for Swift Corelibs Foundation
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="apple-swift-corelibs-foundation"
REPO_URL="https://github.com/apple/swift-corelibs-foundation.git"
PROJECT_NAME="apple-swift-corelibs-foundation"
