#!/usr/bin/env bash
# Auto-generated runner for Runtime Spec
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="opencontainers-runtime-spec"
REPO_URL="https://github.com/opencontainers/runtime-spec.git"
PROJECT_NAME="opencontainers-runtime-spec"
