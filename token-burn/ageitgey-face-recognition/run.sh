#!/usr/bin/env bash
# Auto-generated runner for Face Recognition
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="ageitgey-face-recognition"
REPO_URL="https://github.com/ageitgey/face_recognition.git"
PROJECT_NAME="ageitgey-face-recognition"
