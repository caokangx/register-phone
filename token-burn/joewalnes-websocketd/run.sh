#!/usr/bin/env bash
# Auto-generated runner for Websocketd
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="joewalnes-websocketd"
REPO_URL="https://github.com/joewalnes/websocketd.git"
PROJECT_NAME="joewalnes-websocketd"
