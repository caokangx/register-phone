#!/usr/bin/env bash
# Auto-generated runner for Open Im Server
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="openimsdk-open-im-server"
REPO_URL="https://github.com/openimsdk/open-im-server.git"
PROJECT_NAME="openimsdk-open-im-server"
