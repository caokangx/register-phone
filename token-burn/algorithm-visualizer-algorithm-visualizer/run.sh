#!/usr/bin/env bash
# Auto-generated runner for Algorithm Visualizer
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="algorithm-visualizer-algorithm-visualizer"
REPO_URL="https://github.com/algorithm-visualizer/algorithm-visualizer.git"
PROJECT_NAME="algorithm-visualizer-algorithm-visualizer"
