#!/usr/bin/env bash
# Auto-generated runner for Pocketbase
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="pocketbase-pocketbase"
REPO_URL="https://github.com/pocketbase/pocketbase.git"
PROJECT_NAME="pocketbase-pocketbase"
