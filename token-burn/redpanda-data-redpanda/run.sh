#!/usr/bin/env bash
# Auto-generated runner for Redpanda
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="redpanda-data-redpanda"
REPO_URL="https://github.com/redpanda-data/redpanda.git"
PROJECT_NAME="redpanda-data-redpanda"
