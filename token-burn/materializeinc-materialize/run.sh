#!/usr/bin/env bash
# Auto-generated runner for Materialize
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="materializeinc-materialize"
REPO_URL="https://github.com/materializeinc/materialize.git"
PROJECT_NAME="materializeinc-materialize"
