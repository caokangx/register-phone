#!/usr/bin/env bash
# Auto-generated runner for Nextchat
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="chatgptnextweb-nextchat"
REPO_URL="https://github.com/ChatGPTNextWeb/NextChat.git"
PROJECT_NAME="chatgptnextweb-nextchat"
