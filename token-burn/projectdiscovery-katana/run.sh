#!/usr/bin/env bash
# Auto-generated runner for Katana
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="projectdiscovery-katana"
REPO_URL="https://github.com/projectdiscovery/katana.git"
PROJECT_NAME="projectdiscovery-katana"
