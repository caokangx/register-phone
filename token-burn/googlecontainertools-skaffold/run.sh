#!/usr/bin/env bash
# Auto-generated runner for Skaffold
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="googlecontainertools-skaffold"
REPO_URL="https://github.com/GoogleContainerTools/skaffold.git"
PROJECT_NAME="googlecontainertools-skaffold"
