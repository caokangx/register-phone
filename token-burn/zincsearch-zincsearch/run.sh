#!/usr/bin/env bash
# Auto-generated runner for Zincsearch
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="zincsearch-zincsearch"
REPO_URL="https://github.com/zincsearch/zincsearch.git"
PROJECT_NAME="zincsearch-zincsearch"
