#!/usr/bin/env bash
# Auto-generated runner for Awesome Rust
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="rust-unofficial-awesome-rust"
REPO_URL="https://github.com/rust-unofficial/awesome-rust.git"
PROJECT_NAME="rust-unofficial-awesome-rust"
