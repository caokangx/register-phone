#!/usr/bin/env bash
# Auto-generated runner for Go Admin
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="go-admin-team-go-admin"
REPO_URL="https://github.com/go-admin-team/go-admin.git"
PROJECT_NAME="go-admin-team-go-admin"
