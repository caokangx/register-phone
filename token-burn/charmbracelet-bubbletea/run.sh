#!/usr/bin/env bash
# Auto-generated runner for Bubbletea
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="charmbracelet-bubbletea"
REPO_URL="https://github.com/charmbracelet/bubbletea.git"
PROJECT_NAME="charmbracelet-bubbletea"
