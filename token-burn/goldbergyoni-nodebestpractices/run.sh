#!/usr/bin/env bash
# Auto-generated runner for Nodebestpractices
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="goldbergyoni-nodebestpractices"
REPO_URL="https://github.com/goldbergyoni/nodebestpractices.git"
PROJECT_NAME="goldbergyoni-nodebestpractices"
