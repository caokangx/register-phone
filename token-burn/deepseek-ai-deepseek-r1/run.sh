#!/usr/bin/env bash
# Auto-generated runner for Deepseek R1
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="deepseek-ai-deepseek-r1"
REPO_URL="https://github.com/deepseek-ai/DeepSeek-R1.git"
PROJECT_NAME="deepseek-ai-deepseek-r1"
