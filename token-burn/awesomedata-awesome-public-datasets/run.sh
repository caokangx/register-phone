#!/usr/bin/env bash
# Auto-generated runner for Awesome Public Datasets
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="awesomedata-awesome-public-datasets"
REPO_URL="https://github.com/awesomedata/awesome-public-datasets.git"
PROJECT_NAME="awesomedata-awesome-public-datasets"
