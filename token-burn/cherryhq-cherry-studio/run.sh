#!/usr/bin/env bash
# Auto-generated runner for Cherry Studio
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="cherryhq-cherry-studio"
REPO_URL="https://github.com/CherryHQ/cherry-studio.git"
PROJECT_NAME="cherryhq-cherry-studio"
