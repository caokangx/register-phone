#!/usr/bin/env bash
# Auto-generated runner for Llms From Scratch
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="rasbt-llms-from-scratch"
REPO_URL="https://github.com/rasbt/LLMs-from-scratch.git"
PROJECT_NAME="rasbt-llms-from-scratch"
