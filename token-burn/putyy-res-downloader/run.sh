#!/usr/bin/env bash
# Auto-generated runner for Res Downloader
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="putyy-res-downloader"
REPO_URL="https://github.com/putyy/res-downloader.git"
PROJECT_NAME="putyy-res-downloader"
