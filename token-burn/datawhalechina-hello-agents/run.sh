#!/usr/bin/env bash
# Auto-generated runner for Hello Agents
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="datawhalechina-hello-agents"
REPO_URL="https://github.com/datawhalechina/hello-agents.git"
PROJECT_NAME="datawhalechina-hello-agents"
