#!/usr/bin/env bash
# Auto-generated runner for Timescaledb
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="timescale-timescaledb"
REPO_URL="https://github.com/timescale/timescaledb.git"
PROJECT_NAME="timescale-timescaledb"
