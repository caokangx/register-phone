#!/usr/bin/env bash
# Auto-generated runner for Generative Ai For Beginners
# Usage:
#   ./run.sh              # foreground
...
REPO_URL="https://github.com/microsoft/generative-ai-for-beginners.git"
PROJECT_NAME="microsoft-generative-ai-for-beginners"
