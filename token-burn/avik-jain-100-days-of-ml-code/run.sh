#!/usr/bin/env bash
# Auto-generated runner for 100 Days Of Ml Code
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="avik-jain-100-days-of-ml-code"
REPO_URL="https://github.com/Avik-Jain/100-Days-Of-ML-Code.git"
PROJECT_NAME="avik-jain-100-days-of-ml-code"
