#!/usr/bin/env bash
# Auto-generated runner for Openlist
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="openlistteam-openlist"
REPO_URL="https://github.com/OpenListTeam/OpenList.git"
PROJECT_NAME="openlistteam-openlist"
