#!/usr/bin/env bash
# Auto-generated runner for Awesome Android Ui
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="wasabeef-awesome-android-ui"
REPO_URL="https://github.com/wasabeef/awesome-android-ui.git"
PROJECT_NAME="wasabeef-awesome-android-ui"
