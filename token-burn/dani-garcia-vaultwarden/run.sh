#!/usr/bin/env bash
# Auto-generated runner for Vaultwarden
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="dani-garcia-vaultwarden"
REPO_URL="https://github.com/dani-garcia/vaultwarden.git"
PROJECT_NAME="dani-garcia-vaultwarden"
