#!/usr/bin/env bash
# Auto-generated runner for Stirling Pdf
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="stirling-tools-stirling-pdf"
REPO_URL="https://github.com/Stirling-Tools/Stirling-PDF.git"
PROJECT_NAME="stirling-tools-stirling-pdf"
