#!/usr/bin/env bash
# Auto-generated runner for Professional Programming
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="charlax-professional-programming"
REPO_URL="https://github.com/charlax/professional-programming.git"
PROJECT_NAME="charlax-professional-programming"
