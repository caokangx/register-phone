#!/usr/bin/env bash
# Auto-generated runner for Deepseek V3
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="deepseek-ai-deepseek-v3"
REPO_URL="https://github.com/deepseek-ai/DeepSeek-V3.git"
PROJECT_NAME="deepseek-ai-deepseek-v3"
