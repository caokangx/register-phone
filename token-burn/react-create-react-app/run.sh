#!/usr/bin/env bash
# Auto-generated runner for Create React App
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="react-create-react-app"
REPO_URL="https://github.com/react/create-react-app.git"
PROJECT_NAME="react-create-react-app"
