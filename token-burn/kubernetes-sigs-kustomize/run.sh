#!/usr/bin/env bash
# Auto-generated runner for Kustomize
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="kubernetes-sigs-kustomize"
REPO_URL="https://github.com/kubernetes-sigs/kustomize.git"
PROJECT_NAME="kubernetes-sigs-kustomize"
