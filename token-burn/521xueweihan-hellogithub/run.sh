#!/usr/bin/env bash
# Auto-generated runner for Hellogithub
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="521xueweihan-hellogithub"
REPO_URL="https://github.com/521xueweihan/HelloGitHub.git"
PROJECT_NAME="521xueweihan-hellogithub"
