#!/usr/bin/env bash
# Auto-generated runner for Advanced Go Programming Book
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="chai2010-advanced-go-programming-book"
REPO_URL="https://github.com/chai2010/advanced-go-programming-book.git"
PROJECT_NAME="chai2010-advanced-go-programming-book"
