#!/usr/bin/env bash
# Auto-generated runner for Golang Open Source Projects
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="hackstoic-golang-open-source-projects"
REPO_URL="https://github.com/hackstoic/golang-open-source-projects.git"
PROJECT_NAME="hackstoic-golang-open-source-projects"
