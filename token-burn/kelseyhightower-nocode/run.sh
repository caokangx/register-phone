#!/usr/bin/env bash
# Auto-generated runner for Nocode
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="kelseyhightower-nocode"
REPO_URL="https://github.com/kelseyhightower/nocode.git"
PROJECT_NAME="kelseyhightower-nocode"
