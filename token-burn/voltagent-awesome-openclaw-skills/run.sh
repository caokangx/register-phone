#!/usr/bin/env bash
# Auto-generated runner for Awesome Openclaw Skills
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="voltagent-awesome-openclaw-skills"
REPO_URL="https://github.com/VoltAgent/awesome-openclaw-skills.git"
PROJECT_NAME="voltagent-awesome-openclaw-skills"
