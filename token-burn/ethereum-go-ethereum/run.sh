#!/usr/bin/env bash
# Auto-generated runner for Go Ethereum
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="ethereum-go-ethereum"
REPO_URL="https://github.com/ethereum/go-ethereum.git"
PROJECT_NAME="ethereum-go-ethereum"
