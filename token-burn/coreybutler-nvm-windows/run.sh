#!/usr/bin/env bash
# Auto-generated runner for Nvm Windows
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="coreybutler-nvm-windows"
REPO_URL="https://github.com/coreybutler/nvm-windows.git"
PROJECT_NAME="coreybutler-nvm-windows"
