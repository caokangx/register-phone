#!/usr/bin/env bash
# Auto-generated runner for First Contributions
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="firstcontributions-first-contributions"
REPO_URL="https://github.com/firstcontributions/first-contributions.git"
PROJECT_NAME="firstcontributions-first-contributions"
