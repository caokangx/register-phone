#!/usr/bin/env bash
# Auto-generated runner for Hackbrowserdata
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="moond4rk-hackbrowserdata"
REPO_URL="https://github.com/moonD4rk/HackBrowserData.git"
PROJECT_NAME="moond4rk-hackbrowserdata"
