#!/usr/bin/env bash
# Auto-generated runner for Lazydocker
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="jesseduffield-lazydocker"
REPO_URL="https://github.com/jesseduffield/lazydocker.git"
PROJECT_NAME="jesseduffield-lazydocker"
