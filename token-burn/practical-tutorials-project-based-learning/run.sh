#!/usr/bin/env bash
# Auto-generated runner for Project Based Learning
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="practical-tutorials-project-based-learning"
REPO_URL="https://github.com/practical-tutorials/project-based-learning.git"
PROJECT_NAME="practical-tutorials-project-based-learning"
