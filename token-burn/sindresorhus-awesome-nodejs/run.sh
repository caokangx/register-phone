#!/usr/bin/env bash
# Auto-generated runner for Awesome Nodejs
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="sindresorhus-awesome-nodejs"
REPO_URL="https://github.com/sindresorhus/awesome-nodejs.git"
PROJECT_NAME="sindresorhus-awesome-nodejs"
