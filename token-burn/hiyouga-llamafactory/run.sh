#!/usr/bin/env bash
# Auto-generated runner for Llamafactory
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="hiyouga-llamafactory"
REPO_URL="https://github.com/hiyouga/LlamaFactory.git"
PROJECT_NAME="hiyouga-llamafactory"
