#!/usr/bin/env bash
# Auto-generated runner for Tailwindcss
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="tailwindlabs-tailwindcss"
REPO_URL="https://github.com/tailwindlabs/tailwindcss.git"
PROJECT_NAME="tailwindlabs-tailwindcss"
