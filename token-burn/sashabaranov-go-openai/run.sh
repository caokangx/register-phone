#!/usr/bin/env bash
# Auto-generated runner for Go Openai
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="sashabaranov-go-openai"
REPO_URL="https://github.com/sashabaranov/go-openai.git"
PROJECT_NAME="sashabaranov-go-openai"
