#!/usr/bin/env bash
# Auto-generated runner for 7Days Golang
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="geektutu-7days-golang"
REPO_URL="https://github.com/geektutu/7days-golang.git"
PROJECT_NAME="geektutu-7days-golang"
