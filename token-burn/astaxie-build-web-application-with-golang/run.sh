#!/usr/bin/env bash
# Auto-generated runner for Build Web Application With Golang
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="astaxie-build-web-application-with-golang"
REPO_URL="https://github.com/astaxie/build-web-application-with-golang.git"
PROJECT_NAME="astaxie-build-web-application-with-golang"
