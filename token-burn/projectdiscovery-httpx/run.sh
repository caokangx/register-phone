#!/usr/bin/env bash
# Auto-generated runner for Httpx
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="projectdiscovery-httpx"
REPO_URL="https://github.com/projectdiscovery/httpx.git"
PROJECT_NAME="projectdiscovery-httpx"
