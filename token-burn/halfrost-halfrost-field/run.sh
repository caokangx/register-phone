#!/usr/bin/env bash
# Auto-generated runner for Halfrost Field
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="halfrost-halfrost-field"
REPO_URL="https://github.com/halfrost/Halfrost-Field.git"
PROJECT_NAME="halfrost-halfrost-field"
