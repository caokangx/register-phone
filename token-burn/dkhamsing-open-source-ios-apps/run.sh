#!/usr/bin/env bash
# Auto-generated runner for Open Source Ios Apps
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="dkhamsing-open-source-ios-apps"
REPO_URL="https://github.com/dkhamsing/open-source-ios-apps.git"
PROJECT_NAME="dkhamsing-open-source-ios-apps"
