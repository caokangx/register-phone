#!/usr/bin/env bash
# Auto-generated runner for Free Programming Books Zh Cn
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="justjavac-free-programming-books-zh-cn"
REPO_URL="https://github.com/justjavac/free-programming-books-zh_CN.git"
PROJECT_NAME="justjavac-free-programming-books-zh-cn"
