#!/usr/bin/env bash
# Auto-generated runner for Rust Clippy
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="rust-lang-rust-clippy"
REPO_URL="https://github.com/rust-lang/rust-clippy.git"
PROJECT_NAME="rust-lang-rust-clippy"
