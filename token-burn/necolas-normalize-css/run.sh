#!/usr/bin/env bash
# Auto-generated runner for Normalize.Css
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="necolas-normalize-css"
REPO_URL="https://github.com/necolas/normalize.css.git"
PROJECT_NAME="necolas-normalize-css"
