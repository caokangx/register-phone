#!/usr/bin/env bash
# Auto-generated runner for Openinterpreter
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="openinterpreter-openinterpreter"
REPO_URL="https://github.com/openinterpreter/openinterpreter.git"
PROJECT_NAME="openinterpreter-openinterpreter"
