#!/usr/bin/env bash
# Auto-generated runner for Litestream
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="benbjohnson-litestream"
REPO_URL="https://github.com/benbjohnson/litestream.git"
PROJECT_NAME="benbjohnson-litestream"
