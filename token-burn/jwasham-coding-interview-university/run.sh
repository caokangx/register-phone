#!/usr/bin/env bash
# Auto-generated runner for Coding Interview University
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="jwasham-coding-interview-university"
REPO_URL="https://github.com/jwasham/coding-interview-university.git"
PROJECT_NAME="jwasham-coding-interview-university"
