#!/usr/bin/env bash
# Auto-generated runner for Awesome Wechat Weapp
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="justjavac-awesome-wechat-weapp"
REPO_URL="https://github.com/justjavac/awesome-wechat-weapp.git"
PROJECT_NAME="justjavac-awesome-wechat-weapp"
