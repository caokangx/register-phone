#!/usr/bin/env bash
# Auto-generated runner for Obs Studio
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="obsproject-obs-studio"
REPO_URL="https://github.com/obsproject/obs-studio.git"
PROJECT_NAME="obsproject-obs-studio"
