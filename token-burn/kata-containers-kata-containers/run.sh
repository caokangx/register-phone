#!/usr/bin/env bash
# Auto-generated runner for Kata Containers
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="kata-containers-kata-containers"
REPO_URL="https://github.com/kata-containers/kata-containers.git"
PROJECT_NAME="kata-containers-kata-containers"
