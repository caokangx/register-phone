#!/usr/bin/env bash
# Auto-generated runner for Claude Code Best Practice
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="shanraisshan-claude-code-best-practice"
REPO_URL="https://github.com/shanraisshan/claude-code-best-practice.git"
PROJECT_NAME="shanraisshan-claude-code-best-practice"
