#!/usr/bin/env bash
# Auto-generated runner for Kubernetes The Hard Way
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="kelseyhightower-kubernetes-the-hard-way"
REPO_URL="https://github.com/kelseyhightower/kubernetes-the-hard-way.git"
PROJECT_NAME="kelseyhightower-kubernetes-the-hard-way"
