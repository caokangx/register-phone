#!/usr/bin/env bash
# Auto-generated runner for Free Programming Books
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="ebookfoundation-free-programming-books"
REPO_URL="https://github.com/EbookFoundation/free-programming-books.git"
PROJECT_NAME="ebookfoundation-free-programming-books"
