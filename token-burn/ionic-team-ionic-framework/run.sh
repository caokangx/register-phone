#!/usr/bin/env bash
# Auto-generated runner for Ionic Framework
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="ionic-team-ionic-framework"
REPO_URL="https://github.com/ionic-team/ionic-framework.git"
PROJECT_NAME="ionic-team-ionic-framework"
