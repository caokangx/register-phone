#!/usr/bin/env bash
# Auto-generated runner for Crowdsec
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="crowdsecurity-crowdsec"
REPO_URL="https://github.com/crowdsecurity/crowdsec.git"
PROJECT_NAME="crowdsecurity-crowdsec"
