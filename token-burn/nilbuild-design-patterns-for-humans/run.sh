#!/usr/bin/env bash
# Auto-generated runner for Design Patterns For Humans
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="nilbuild-design-patterns-for-humans"
REPO_URL="https://github.com/nilbuild/design-patterns-for-humans.git"
PROJECT_NAME="nilbuild-design-patterns-for-humans"
