#!/usr/bin/env bash
# Auto-generated runner for Win11Debloat
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="raphire-win11debloat"
REPO_URL="https://github.com/Raphire/Win11Debloat.git"
PROJECT_NAME="raphire-win11debloat"
