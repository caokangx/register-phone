#!/usr/bin/env bash
# Auto-generated runner for Build Your Own X
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="codecrafters-io-build-your-own-x"
REPO_URL="https://github.com/codecrafters-io/build-your-own-x.git"
PROJECT_NAME="codecrafters-io-build-your-own-x"
