#!/usr/bin/env bash
# Auto-generated runner for Definitelytyped
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="definitelytyped-definitelytyped"
REPO_URL="https://github.com/DefinitelyTyped/DefinitelyTyped.git"
PROJECT_NAME="definitelytyped-definitelytyped"
