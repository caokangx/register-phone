#!/usr/bin/env bash
# Auto-generated runner for Chinatextbook
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="tapxworld-chinatextbook"
REPO_URL="https://github.com/TapXWorld/ChinaTextbook.git"
PROJECT_NAME="tapxworld-chinatextbook"
