#!/usr/bin/env bash
# Auto-generated runner for Billionmail
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="billionmail-billionmail"
REPO_URL="https://github.com/Billionmail/BillionMail.git"
PROJECT_NAME="billionmail-billionmail"
