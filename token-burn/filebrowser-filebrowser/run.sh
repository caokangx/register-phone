#!/usr/bin/env bash
# Auto-generated runner for Filebrowser
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="filebrowser-filebrowser"
REPO_URL="https://github.com/filebrowser/filebrowser.git"
PROJECT_NAME="filebrowser-filebrowser"
