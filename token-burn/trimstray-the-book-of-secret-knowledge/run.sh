#!/usr/bin/env bash
# Auto-generated runner for The Book Of Secret Knowledge
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="trimstray-the-book-of-secret-knowledge"
REPO_URL="https://github.com/trimstray/the-book-of-secret-knowledge.git"
PROJECT_NAME="trimstray-the-book-of-secret-knowledge"
