#!/usr/bin/env bash
# Auto-generated runner for Prompt Engineering Guide
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="dair-ai-prompt-engineering-guide"
REPO_URL="https://github.com/dair-ai/Prompt-Engineering-Guide.git"
PROJECT_NAME="dair-ai-prompt-engineering-guide"
