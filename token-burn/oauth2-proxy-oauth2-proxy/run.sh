#!/usr/bin/env bash
# Auto-generated runner for Oauth2 Proxy
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="oauth2-proxy-oauth2-proxy"
REPO_URL="https://github.com/oauth2-proxy/oauth2-proxy.git"
PROJECT_NAME="oauth2-proxy-oauth2-proxy"
