#!/usr/bin/env bash
# Auto-generated runner for System Design 101
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="bytebytegohq-system-design-101"
REPO_URL="https://github.com/ByteByteGoHq/system-design-101.git"
PROJECT_NAME="bytebytegohq-system-design-101"
