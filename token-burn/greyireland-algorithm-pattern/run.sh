#!/usr/bin/env bash
# Auto-generated runner for Algorithm Pattern
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="greyireland-algorithm-pattern"
REPO_URL="https://github.com/greyireland/algorithm-pattern.git"
PROJECT_NAME="greyireland-algorithm-pattern"
