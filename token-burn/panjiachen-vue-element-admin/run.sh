#!/usr/bin/env bash
# Auto-generated runner for Vue Element Admin
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="panjiachen-vue-element-admin"
REPO_URL="https://github.com/PanJiaChen/vue-element-admin.git"
PROJECT_NAME="panjiachen-vue-element-admin"
