#!/usr/bin/env bash
# Auto-generated runner for Opentelemetry Collector
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="open-telemetry-opentelemetry-collector"
REPO_URL="https://github.com/open-telemetry/opentelemetry-collector.git"
PROJECT_NAME="open-telemetry-opentelemetry-collector"
