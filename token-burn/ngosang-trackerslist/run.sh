#!/usr/bin/env bash
# Auto-generated runner for Trackerslist
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="ngosang-trackerslist"
REPO_URL="https://github.com/ngosang/trackerslist.git"
PROJECT_NAME="ngosang-trackerslist"
