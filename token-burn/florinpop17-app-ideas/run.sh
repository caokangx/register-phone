#!/usr/bin/env bash
# Auto-generated runner for App Ideas
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="florinpop17-app-ideas"
REPO_URL="https://github.com/florinpop17/app-ideas.git"
PROJECT_NAME="florinpop17-app-ideas"
