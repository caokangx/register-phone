#!/usr/bin/env bash
# Auto-generated runner for Ant Design
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="ant-design-ant-design"
REPO_URL="https://github.com/ant-design/ant-design.git"
PROJECT_NAME="ant-design-ant-design"
