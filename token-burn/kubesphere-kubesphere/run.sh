#!/usr/bin/env bash
# Auto-generated runner for Kubesphere
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="kubesphere-kubesphere"
REPO_URL="https://github.com/kubesphere/kubesphere.git"
PROJECT_NAME="kubesphere-kubesphere"
