#!/usr/bin/env bash
# Auto-generated runner for Noisetorch
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="noisetorch-noisetorch"
REPO_URL="https://github.com/noisetorch/NoiseTorch.git"
PROJECT_NAME="noisetorch-noisetorch"
