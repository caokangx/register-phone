#!/usr/bin/env bash
# Auto-generated runner for Open Source Mac Os Apps
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="serhii-londar-open-source-mac-os-apps"
REPO_URL="https://github.com/serhii-londar/open-source-mac-os-apps.git"
PROJECT_NAME="serhii-londar-open-source-mac-os-apps"
