#!/usr/bin/env bash
# Auto-generated runner for Microsoft Activation Scripts
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="massgravel-microsoft-activation-scripts"
REPO_URL="https://github.com/massgravel/Microsoft-Activation-Scripts.git"
PROJECT_NAME="massgravel-microsoft-activation-scripts"
