#!/usr/bin/env bash
# Auto-generated runner for Html5 Boilerplate
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="h5bp-html5-boilerplate"
REPO_URL="https://github.com/h5bp/html5-boilerplate.git"
PROJECT_NAME="h5bp-html5-boilerplate"
