#!/usr/bin/env bash
# Auto-generated runner for Architect Awesome
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="xingshaocheng-architect-awesome"
REPO_URL="https://github.com/xingshaocheng/architect-awesome.git"
PROJECT_NAME="xingshaocheng-architect-awesome"
