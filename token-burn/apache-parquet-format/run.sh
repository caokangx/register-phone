#!/usr/bin/env bash
# Auto-generated runner for Parquet Format
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="apache-parquet-format"
REPO_URL="https://github.com/apache/parquet-format.git"
PROJECT_NAME="apache-parquet-format"
