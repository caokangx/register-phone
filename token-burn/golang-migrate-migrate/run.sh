#!/usr/bin/env bash
# Auto-generated runner for Migrate
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="golang-migrate-migrate"
REPO_URL="https://github.com/golang-migrate/migrate.git"
PROJECT_NAME="golang-migrate-migrate"
