#!/usr/bin/env bash
# Auto-generated runner for Papers We Love
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="papers-we-love-papers-we-love"
REPO_URL="https://github.com/papers-we-love/papers-we-love.git"
PROJECT_NAME="papers-we-love-papers-we-love"
