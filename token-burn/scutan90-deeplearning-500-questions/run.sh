#!/usr/bin/env bash
# Auto-generated runner for Deeplearning 500 Questions
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="scutan90-deeplearning-500-questions"
REPO_URL="https://github.com/scutan90/DeepLearning-500-questions.git"
PROJECT_NAME="scutan90-deeplearning-500-questions"
