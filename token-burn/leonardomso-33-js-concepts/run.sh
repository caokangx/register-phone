#!/usr/bin/env bash
# Auto-generated runner for 33 Js Concepts
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="leonardomso-33-js-concepts"
REPO_URL="https://github.com/leonardomso/33-js-concepts.git"
PROJECT_NAME="leonardomso-33-js-concepts"
