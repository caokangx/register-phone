#!/usr/bin/env bash
# Auto-generated runner for Awesome Flutter
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="solido-awesome-flutter"
REPO_URL="https://github.com/Solido/awesome-flutter.git"
PROJECT_NAME="solido-awesome-flutter"
