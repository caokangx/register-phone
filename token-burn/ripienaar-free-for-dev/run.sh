#!/usr/bin/env bash
# Auto-generated runner for Free For Dev
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="ripienaar-free-for-dev"
REPO_URL="https://github.com/ripienaar/free-for-dev.git"
PROJECT_NAME="ripienaar-free-for-dev"
