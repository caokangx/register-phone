#!/usr/bin/env bash
# Auto-generated runner for Lx Music Desktop
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="lyswhut-lx-music-desktop"
REPO_URL="https://github.com/lyswhut/lx-music-desktop.git"
PROJECT_NAME="lyswhut-lx-music-desktop"
