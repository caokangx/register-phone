#!/usr/bin/env bash
# Auto-generated runner for Leetcodeanimation
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="misterbooo-leetcodeanimation"
REPO_URL="https://github.com/MisterBooo/LeetCodeAnimation.git"
PROJECT_NAME="misterbooo-leetcodeanimation"
