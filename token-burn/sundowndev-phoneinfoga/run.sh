#!/usr/bin/env bash
# Auto-generated runner for Phoneinfoga
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="sundowndev-phoneinfoga"
REPO_URL="https://github.com/sundowndev/phoneinfoga.git"
PROJECT_NAME="sundowndev-phoneinfoga"
