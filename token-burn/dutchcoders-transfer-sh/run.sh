#!/usr/bin/env bash
# Auto-generated runner for Transfer.Sh
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="dutchcoders-transfer-sh"
REPO_URL="https://github.com/dutchcoders/transfer.sh.git"
PROJECT_NAME="dutchcoders-transfer-sh"
