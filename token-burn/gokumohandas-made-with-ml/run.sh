#!/usr/bin/env bash
# Auto-generated runner for Made With Ml
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="gokumohandas-made-with-ml"
REPO_URL="https://github.com/GokuMohandas/Made-With-ML.git"
PROJECT_NAME="gokumohandas-made-with-ml"
