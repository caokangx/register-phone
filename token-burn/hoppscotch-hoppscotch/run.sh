#!/usr/bin/env bash
# Auto-generated runner for Hoppscotch
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="hoppscotch-hoppscotch"
REPO_URL="https://github.com/hoppscotch/hoppscotch.git"
PROJECT_NAME="hoppscotch-hoppscotch"
