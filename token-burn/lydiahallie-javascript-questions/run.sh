#!/usr/bin/env bash
# Auto-generated runner for Javascript Questions
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="lydiahallie-javascript-questions"
REPO_URL="https://github.com/lydiahallie/javascript-questions.git"
PROJECT_NAME="lydiahallie-javascript-questions"
