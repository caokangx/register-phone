#!/usr/bin/env bash
# Auto-generated runner for Cs Video Courses
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="developer-y-cs-video-courses"
REPO_URL="https://github.com/Developer-Y/cs-video-courses.git"
PROJECT_NAME="developer-y-cs-video-courses"
