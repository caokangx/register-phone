#!/usr/bin/env bash
# Auto-generated runner for Skopeo
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="podman-container-tools-skopeo"
REPO_URL="https://github.com/podman-container-tools/skopeo.git"
PROJECT_NAME="podman-container-tools-skopeo"
