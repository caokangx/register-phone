#!/usr/bin/env bash
# Auto-generated runner for Ultimate Go
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="hoanhan101-ultimate-go"
REPO_URL="https://github.com/hoanhan101/ultimate-go.git"
PROJECT_NAME="hoanhan101-ultimate-go"
