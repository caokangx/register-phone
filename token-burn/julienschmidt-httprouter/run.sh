#!/usr/bin/env bash
# Auto-generated runner for Httprouter
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="julienschmidt-httprouter"
REPO_URL="https://github.com/julienschmidt/httprouter.git"
PROJECT_NAME="julienschmidt-httprouter"
