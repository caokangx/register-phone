#!/usr/bin/env bash
# Auto-generated runner for Ai For Beginners
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="microsoft-ai-for-beginners"
REPO_URL="https://github.com/microsoft/AI-For-Beginners.git"
PROJECT_NAME="microsoft-ai-for-beginners"
