#!/usr/bin/env bash
# Auto-generated runner for Json Server
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="typicode-json-server"
REPO_URL="https://github.com/typicode/json-server.git"
PROJECT_NAME="typicode-json-server"
