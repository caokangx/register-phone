#!/usr/bin/env bash
# Auto-generated runner for Rabbitmq Server
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="rabbitmq-rabbitmq-server"
REPO_URL="https://github.com/rabbitmq/rabbitmq-server.git"
PROJECT_NAME="rabbitmq-rabbitmq-server"
