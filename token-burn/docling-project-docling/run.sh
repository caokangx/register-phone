#!/usr/bin/env bash
# Auto-generated runner for Docling
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="docling-project-docling"
REPO_URL="https://github.com/docling-project/docling.git"
PROJECT_NAME="docling-project-docling"
