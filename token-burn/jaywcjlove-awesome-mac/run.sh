#!/usr/bin/env bash
# Auto-generated runner for Awesome Mac
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="jaywcjlove-awesome-mac"
REPO_URL="https://github.com/jaywcjlove/awesome-mac.git"
PROJECT_NAME="jaywcjlove-awesome-mac"
