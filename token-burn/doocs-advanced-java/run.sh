#!/usr/bin/env bash
# Auto-generated runner for Advanced Java
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="doocs-advanced-java"
REPO_URL="https://github.com/doocs/advanced-java.git"
PROJECT_NAME="doocs-advanced-java"
