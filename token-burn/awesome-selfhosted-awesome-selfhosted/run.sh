#!/usr/bin/env bash
# Auto-generated runner for Awesome Selfhosted
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="awesome-selfhosted-awesome-selfhosted"
REPO_URL="https://github.com/awesome-selfhosted/awesome-selfhosted.git"
PROJECT_NAME="awesome-selfhosted-awesome-selfhosted"
