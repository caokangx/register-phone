#!/usr/bin/env bash
# Auto-generated runner for Semantic Ui
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="semantic-org-semantic-ui"
REPO_URL="https://github.com/Semantic-Org/Semantic-UI.git"
PROJECT_NAME="semantic-org-semantic-ui"
