#!/usr/bin/env bash
# Auto-generated runner for Github Chinese Top Charts
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="growinggit-github-chinese-top-charts"
REPO_URL="https://github.com/GrowingGit/GitHub-Chinese-Top-Charts.git"
PROJECT_NAME="growinggit-github-chinese-top-charts"
