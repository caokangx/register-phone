#!/usr/bin/env bash
# Auto-generated runner for Ml For Beginners
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="microsoft-ml-for-beginners"
REPO_URL="https://github.com/microsoft/ML-For-Beginners.git"
PROJECT_NAME="microsoft-ml-for-beginners"
