#!/usr/bin/env bash
# Auto-generated runner for Hiring Without Whiteboards
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="poteto-hiring-without-whiteboards"
REPO_URL="https://github.com/poteto/hiring-without-whiteboards.git"
PROJECT_NAME="poteto-hiring-without-whiteboards"
