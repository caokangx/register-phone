#!/usr/bin/env bash
# Auto-generated runner for Openmanus
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="foundationagents-openmanus"
REPO_URL="https://github.com/FoundationAgents/OpenManus.git"
PROJECT_NAME="foundationagents-openmanus"
