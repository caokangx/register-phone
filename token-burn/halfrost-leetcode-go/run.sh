#!/usr/bin/env bash
# Auto-generated runner for Leetcode Go
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="halfrost-leetcode-go"
REPO_URL="https://github.com/halfrost/LeetCode-Go.git"
PROJECT_NAME="halfrost-leetcode-go"
