#!/usr/bin/env bash
# Auto-generated runner for Private Gpt
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="zylon-ai-private-gpt"
REPO_URL="https://github.com/zylon-ai/private-gpt.git"
PROJECT_NAME="zylon-ai-private-gpt"
