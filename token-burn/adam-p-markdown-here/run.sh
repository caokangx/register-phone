#!/usr/bin/env bash
# Auto-generated runner for Markdown Here
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="adam-p-markdown-here"
REPO_URL="https://github.com/adam-p/markdown-here.git"
PROJECT_NAME="adam-p-markdown-here"
