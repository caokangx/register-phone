#!/usr/bin/env bash
# Auto-generated runner for Podman
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="podman-container-tools-podman"
REPO_URL="https://github.com/podman-container-tools/podman.git"
PROJECT_NAME="podman-container-tools-podman"
