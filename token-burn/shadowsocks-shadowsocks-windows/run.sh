#!/usr/bin/env bash
# Auto-generated runner for Shadowsocks Windows
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="shadowsocks-shadowsocks-windows"
REPO_URL="https://github.com/shadowsocks/shadowsocks-windows.git"
PROJECT_NAME="shadowsocks-shadowsocks-windows"
