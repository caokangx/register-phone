#!/usr/bin/env bash
# Auto-generated runner for The Art Of Command Line
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="jlevy-the-art-of-command-line"
REPO_URL="https://github.com/jlevy/the-art-of-command-line.git"
PROJECT_NAME="jlevy-the-art-of-command-line"
