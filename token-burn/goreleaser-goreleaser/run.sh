#!/usr/bin/env bash
# Auto-generated runner for Goreleaser
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="goreleaser-goreleaser"
REPO_URL="https://github.com/goreleaser/goreleaser.git"
PROJECT_NAME="goreleaser-goreleaser"
