#!/usr/bin/env bash
# Auto-generated runner for Awesome Scalability
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="binhnguyennus-awesome-scalability"
REPO_URL="https://github.com/binhnguyennus/awesome-scalability.git"
PROJECT_NAME="binhnguyennus-awesome-scalability"
