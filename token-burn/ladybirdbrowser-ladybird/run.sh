#!/usr/bin/env bash
# Auto-generated runner for Ladybird
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="ladybirdbrowser-ladybird"
REPO_URL="https://github.com/LadybirdBrowser/ladybird.git"
PROJECT_NAME="ladybirdbrowser-ladybird"
