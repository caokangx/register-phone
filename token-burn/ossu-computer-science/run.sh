#!/usr/bin/env bash
# Auto-generated runner for Computer Science
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="ossu-computer-science"
REPO_URL="https://github.com/ossu/computer-science.git"
PROJECT_NAME="ossu-computer-science"
