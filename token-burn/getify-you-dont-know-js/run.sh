#!/usr/bin/env bash
# Auto-generated runner for You Dont Know Js
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="getify-you-dont-know-js"
REPO_URL="https://github.com/getify/You-Dont-Know-JS.git"
PROJECT_NAME="getify-you-dont-know-js"
