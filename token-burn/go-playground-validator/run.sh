#!/usr/bin/env bash
# Auto-generated runner for Validator
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="go-playground-validator"
REPO_URL="https://github.com/go-playground/validator.git"
PROJECT_NAME="go-playground-validator"
