#!/usr/bin/env bash
# Auto-generated runner for Drawio Desktop
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="jgraph-drawio-desktop"
REPO_URL="https://github.com/jgraph/drawio-desktop.git"
PROJECT_NAME="jgraph-drawio-desktop"
