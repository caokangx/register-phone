#!/usr/bin/env bash
# Auto-generated runner for Kubernetes Ingress Controller
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="kong-kubernetes-ingress-controller"
REPO_URL="https://github.com/kong/kubernetes-ingress-controller.git"
PROJECT_NAME="kong-kubernetes-ingress-controller"
