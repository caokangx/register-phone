#!/usr/bin/env bash
# Auto-generated runner for Fucking Algorithm
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="labuladong-fucking-algorithm"
REPO_URL="https://github.com/labuladong/fucking-algorithm.git"
PROJECT_NAME="labuladong-fucking-algorithm"
