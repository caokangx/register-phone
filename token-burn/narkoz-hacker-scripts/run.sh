#!/usr/bin/env bash
# Auto-generated runner for Hacker Scripts
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="narkoz-hacker-scripts"
REPO_URL="https://github.com/NARKOZ/hacker-scripts.git"
PROJECT_NAME="narkoz-hacker-scripts"
