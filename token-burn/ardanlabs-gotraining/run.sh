#!/usr/bin/env bash
# Auto-generated runner for Gotraining
# Usage:
#   ./run.sh              # foreground
...
PROJECT_ID="ardanlabs-gotraining"
REPO_URL="https://github.com/ardanlabs/gotraining.git"
PROJECT_NAME="ardanlabs-gotraining"
